        ...
        <div className="flex relative z-10">
          ...
          <div className="hidden lg:flex w-1/2 relative overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center z-20">
              <div className="text-center text-white">
                ...
                <p className="text-lg font-light opacity-80">Sterling Parfums</p>
          ...
          <div className="w-full lg:w-1/2 p-12 lg:p-16">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300 text-lg font-light">Enter your exclusive portal</p>
            ...
            <form onSubmit={handleLogin} className="space-y-8">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link to="/forgot-password" className="text-purple-400 hover:text-purple-300 transition-colors font-light">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="mt-8 text-center">
              ...
              <p className="text-gray-300 font-light">
                New to Cornells?{" "}
                <Link to="/create-account" className="text-purple-400 hover:text-purple-300 transition-colors font-normal">
                  Create your account
                </Link>
              </p>
            </div>
