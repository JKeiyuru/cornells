...
// pages/Login.jsx - Rekker Professional Business Login (Red Theme)
      ...
      <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden max-w-4xl w-full border border-white/10">
        ...
        <div className="flex relative z-10">
          ...
          <div className="hidden lg:flex w-1/2 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-red-600/20 to-rose-600/20 z-10"></div>
            <img
          ...
          <div className="w-full lg:w-1/2 p-12 lg:p-16">
            ...
            <form onSubmit={handleLogin} className="space-y-8">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center text-gray-300 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 rounded border-white/20 bg-white/5 text-red-500 focus:ring-red-500 focus:ring-offset-0" />
                  <span className="ml-2 font-light">Remember me</span>
                </label>
                <Link to="/forgot-password" className="text-red-400 hover:text-red-300 transition-colors font-light">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="mt-8 text-center">
              ...
              <p className="text-gray-300 font-light mb-4">
                ...
                <Link to="/create-account" className="text-red-400 hover:text-red-300 transition-colors font-normal">
