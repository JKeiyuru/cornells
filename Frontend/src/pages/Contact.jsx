      ...
      <div className="container mx-auto px-6 py-16">
        <div className="max-w-7xl mx-auto">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-blue-600 to-teal-600 text-white py-4 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center space-x-2"
                  >
                    {isSubmitting ? (
                      <>
            ...
            <div className={`lg:col-span-1 space-y-8 transition-all duration-700 delay-500 ${isLoaded ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-8'}`}>
              ...
              <div className="bg-white rounded-2xl shadow-xl p-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="#" className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center text-blue-600 hover:bg-blue-200 transition-colors">
                    <FaLinkedin className="w-6 h-6" />
                  </a>
                  <a href="#" className="w-12 h-12 bg-sky-100 rounded-lg flex items-center justify-center text-sky-600 hover:bg-sky-200 transition-colors">
              ...
              <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-6 border border-red-100">
                ...
                <div className="space-y-2 text-sm">
                  <p className="font-medium text-gray-900">+254 722 URGENT (864368)</p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {departments.map((dept, index) => (
                <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 text-center group">
                  ...
                  <div className="space-y-2 text-sm">
                    <a href={`mailto:${dept.contact}`} className="block text-blue-600 hover:text-blue-700">
                      {dept.contact}
                    </a>
                    <a href={`tel:${dept.phone}`} className="block text-gray-700 hover:text-gray-900">
                      {dept.phone}
                    </a>
                  </div>
                </div>
          ...
          <div className="mt-20 bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="p-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Find Our Office</h2>
